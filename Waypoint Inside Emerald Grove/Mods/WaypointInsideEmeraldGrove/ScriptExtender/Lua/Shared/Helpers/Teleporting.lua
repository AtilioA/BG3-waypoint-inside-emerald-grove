...
--[[ TODO:
    - Unlock waypoint if flag is set or detected to be true
        - (String handle for 'Emerald Grove', waypoint UUID, character GUID)
        - UnlockWaypoint(Ext.Loca.GetTranslatedString("h81b3d919g1924g4133g9331g01162447d63b"), "de94548d-03eb-4b5d-bf29-000b96f0dfe1", GetHostCharacter())
    - Don't teleport if user setting is THE HOLLOW
    - Figure out how to pak this override with the mod itself
--]]
